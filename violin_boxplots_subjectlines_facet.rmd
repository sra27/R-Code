##Read in data
```{r Read in data, results="hide",warning=FALSE, message=FALSE}
...
```{r Combine into 1 plot - PINES IAPS Task, results="hide",warning=FALSE, message=FALSE}
#combine into 1 plot 
...
##Plot with ggplot
```{r Plot with ggplot, results="hide",warning=FALSE, message=FALSE}
